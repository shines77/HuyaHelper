...
namespace HuyaHelper
{
    ...
    class Messages
    {
        ...
        // 消息数据类型 (小于 typeFlag 为字符, 大于 typeFlag 为二进制)
        public const uint BytesType  = 0xA000;
        public const uint NoticeType = 0xA001;
        public const uint GiftType   = 0xA002;
        public const uint StringType = 0x8000;
        public const uint TypeFlag   = 0x8000;
    }
}
